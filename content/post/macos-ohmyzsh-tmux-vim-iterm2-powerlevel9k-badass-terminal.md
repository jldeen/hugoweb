...
description = ""
draft = false
image = "Screen-Shot-2017-04-14-at-21.28.11_iwtuhb.png"
...
![](https://cdn.jessicadeen.com/content/images/Screen-Shot-2017-04-14-at-21.28.11_iwtuhb.png)
...
![](https://cdn.jessicadeen.com/content/images/Screen-Shot-2017-04-14-at-21.06.51_svcqgt.png)
...
set -g status-position bottom set -g status-bg colour237 set -g status-fg colour137 set -g status-attr dim set -g status-left '#[fg=colour197]#(~/bin/internet_info.sh) #{tasks_status} ' set -g status-right '#[fg=colour81]♪ #(~/bin/now_playing.sh) #(~/bin/battery.sh) #[fg=colour255,bg=colour241,bold] %a %m-%d #[fg=colour255,bg=colour241,bold] %H:%M:%S #[fg=colour165]#[bg=default] #H ' set -g status-right-length 100 set -g status-left-length 70
...
![](https://cdn.jessicadeen.com/content/images/Screen-Shot-2017-04-14-at-21.51.48_lju1kn.png)
...
![](https://cdn.jessicadeen.com/content/images/Screen-Shot-2017-04-15-at-00.08.12_rmulc2.png)
