...
description = ""
draft = false
image = "windows-10-update-anniversary_phaofv.jpg"
...
9. Action Center Updates You can see some minor improvements to notifications in your Action Center such as the ability to set priority notifications, which means apps you care about most will appear at the top of your Action Center feed. You can even control limits for how many notifications you want per app (the default is set to three).
10. Taskbar Updates Along with updates to the Action Center, you now have a notification icon in the taskbar indicating how many unread notifications / unattended tasks you have. Along with notification updates, you now also have some taskbar calendar updates to highlight! The taskbar calendar now ties into your main calendar app so you can see all your appointments / tasks for the day. And, one more bonus feature, if you are someone who uses multiple monitors, you will now be able to see the time and date on all your monitors, not just your primary one.
