+++
author = "jldeen"
categories = ["financial independence", "IRA", "LearnVest", "money", "plannning", "retirement", "spending", "Young Adults"]
date = 2014-04-18T08:00:40Z
description = ""
draft = false
image = "../../images/quote-i-always-knew-i-was-going-to-be-rich-i-don-t-think-i-ever-doubted-it-for-a-minute-warren-buffett-26774_rkg2mn.jpg"
...
I began saving in an ING account, which is now known as <span style="text-decoration: underline; color: #042eee;">Capital One 360</span>, because, at the time, it boasted a variable 0.8% APY (Annual Percentage Yield). Side note — as of yesterday (4/17/2014) the rate changed to 0.75%, which, all things considering, is still a very good rate as Capital One 360 allows you to start with a $0 minimum and does not charge any fees.
...
Rather than going out and buying the newest pair of Jordans to hit the shelf, the latest Louis Vuitton bag, or the hottest pair of Gucci’s, put money away first for an emergency <span style="text-decoration: underline;">and</span> retirement. Now, please know I am not suggesting that you never spend money on goals or desirable and expensive things / trips. Lord knows I have my own LV items and Gucci sunglasses, but it took me 5 years to let myself purchase them.
