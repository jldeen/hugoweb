...
![](/images/Screen-Shot-2018-03-08-at-16.20.04_fu7oeh.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.22.26_l7furk.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.24.35_nluyir.png)

I will opt to start with an empty process.

![](/images/Screen-Shot-2018-03-08-at-16.25.48_q9llvt.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.27.18_iiwhfz.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.28.31_k9uu67.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.34.40_soaoht.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.34.57_ifyeca.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.39.16_rce1gn.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.41.54_rxxt2s.png)

We will start by creating a new definition.

![](/images/Screen-Shot-2018-03-08-at-16.43.30_xp3esw.png)

And again chose “Empty Process.”

![](/images/Screen-Shot-2018-03-08-at-16.44.13_uxt6vy.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.46.05_zoxg2e.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.48.29_ibqsqw.png)

Let’s also add a continuous deployment trigger.

![](/images/Screen-Shot-2018-03-08-at-16.51.45_cow1rw.png)![](/images/Screen-Shot-2018-03-08-at-16.51.54_vll3xw.png)

And now let’s configure our dev environment’s tasks.

![](/images/Screen-Shot-2018-03-08-at-16.54.34_u5ff0a.png)

Under Agent Phase, we again will tell our Release to use a Hosted Linux Agent for our Agent queue.

![](/images/Screen-Shot-2018-03-08-at-16.56.11_iksd62.png)
...
![](/images/Screen-Shot-2018-03-08-at-16.57.28_hutrfq.png)

![](/images/Screen-Shot-2018-03-08-at-16.59.16_pvdrqg.png)

Now we have to setup our Kubernetes Service Connection. Under the first Kubernetes task, you will see an option for it with a “Manage” link right next to it. Let’s open that in a new tab. ![](/images/Screen-Shot-2018-03-08-at-17.01.47_zit0bf.png)

From there, click “New Service Endpoint” in the top left corner and select Kubernetes.

![](/images/Screen-Shot-2018-03-08-at-17.02.37_rfrbja.png)

You will then need to put in your Kubernetes cluster information. You can find it in $HOME/.kube/config. ![](/images/Screen-Shot-2018-03-08-at-17.04.53_xo9n51.png)
...
![](/images/Screen-Shot-2018-03-08-at-17.14.35_qxzwdu.png)
...
![](/images/Screen-Shot-2018-03-08-at-17.14.18_lyn4ht.png)
...
![](/images/Screen-Shot-2018-03-08-at-17.16.01_kg6crx.png)
...
![](/images/Screen-Shot-2018-03-08-at-17.24.47_bprih1.png)

![](/images/Screen-Shot-2018-03-08-at-17.23.45_kf8c2t.png)
...
imagesecret
```
![](/images/Screen-Shot-2018-03-08-at-17.29.50_ewudo4.png)

Rename your release definition, be sure to use all lowercase letters, and then save it.

![](/images/Screen-Shot-2018-03-08-at-17.31.22_kcy5ox.png)

Now, we are ready to go back to our Builds tab and hit “Queue New Build.”

![](/images/Screen-Shot-2018-03-08-at-17.33.35_nyahbh.png)

We can watch as our build completes.

![](/images/Screen-Shot-2018-03-08-at-19.44.20_pgq0vg.png)

And now let’s go create a release using our newly completed build.

![](/images/Screen-Shot-2018-03-08-at-19.57.01_mxv56u.png)

![](/images/Screen-Shot-2018-03-08-at-19.57.48_yn7y52.png)
...
![](/images/Screen-Shot-2018-03-08-at-17.48.07_tphbxt.png)
