...
This site uses GitHub Actions to deploy to AWS Amplify. This means each time you open a PR, your code changes will be automatically deployed to that PR / staging environment where you can run your acceptance tests / validation tests / visual tests, etc. 

You can learn about how to get started with Hugo and AWS Amplify [here](https://aws.amazon.com/blogs/devops/agile-website-delivery-with-hugo-and-aws-amplify/). 
